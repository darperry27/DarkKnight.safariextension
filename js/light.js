...
///////////
	...
	function reader() {
		...
		if (readerontext != null && readeronrange != null) {
			safari.self.tab.dispatchMessage('interval', readerontext.value);
		}
		...
		if (readerlargestyle != null && readerlargeimgclick != null && readerlargetitleclick != null) {
			if(readerlargestyle.style.width == '24px'){safari.self.tab.dispatchMessage('readerlargestyle', "false");}
			else{safari.self.tab.dispatchMessage('readerlargestyle', "true");}
		}	
		}
...
/////////// Turn Off the Lights reader slider
	...
	// totlreaderbarimg1.setAttribute('src',''+safari.extension.baseURI+"images/minimize.png"+'');
	totlreaderbarimg1.addEventListener('click',function (e) {toggle_small()}, true);
	// totlreaderbarimg1.addEventListener("mouseover",function (e) {totlreaderbarimg1.setAttribute('src',''+safari.extension.baseURI+"images/minimize_on.png"+'');}, false);
	...
	totlreaderbardiv3.style.backgroundImage = 'url('+safari.extension.baseURI+"icon-16.png"+')';
...
/* begin remove all elements (fix safari) */
	var stefanvdlightareoff1 = $('stefanvdlightareoff1');
	var stefanvdlightareoff2 = $('stefanvdlightareoff2');
	var stefanvdlightareoff3 = $('stefanvdlightareoff3');
	var stefanvdlightareoff4 = $('stefanvdlightareoff4');
	...
	var totlmousespotlightscript = $("totlmousespotlightscript");
